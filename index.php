...
<div class="intro no-padding">
	...
	<video autoplay loop id="video-background" plays-inline>
		<source src="//<?php echo $_SERVER['SERVER_NAME'];?>/bg-home.mp4" type="video/mp4" playsinline webkit-playsinline autoplay muted loop>
	</video>
 ...
 <div class="container">
    ...
    <div class="row hide-mobile">
      <div class="col-sm-12 col-md-12 text-center" id="leao-topo">
           <img src="//<?php echo $_SERVER['SERVER_NAME'];?>/img/leao-brecoins.png" alt="Leão ícone da BRE Coins – cotação para comprar ou vender bitcoins – faça sua carteira" />
      </div>
    </div>
...
$vol_bit = $data->{'vol_crypto'};
$last = $last/10;
$open = $open/10;
$variacao = 100 - ( (100*$last)/$open );

function convertToBTCFromSatoshi($vol_bit) {
    $BTC = $vol_bit / 100000000 ;
    return $BTC;
}
function formatBTC($vol_bit) {
    $vol_bit = sprintf('%.8f', $vol_bit);
    $vol_bit = rtrim($vol_bit, '0');
    return $vol_bit;
}
...
?>
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12">
            <a class="btn-padrao-no-margin montserrat-semi text-center font-size-20" href="https://broker.brecoins.com.br/?p=signup" rel="nofollow">CADASTRE-SE</a>
      </div>
    </div>
...
<div class="container" id="variacao">
      ...
      <div class="col-xs-12 col-xsl-4 col-sm-4 col-md-5 text-right">
        <div class="branco montserrat-regular font-size-18 hint--top" aria-label="Volume de Bitcoins negociado nas últimas 24hs!"><span class="verde montserrat-extra"> <i class="fa fa-btc" aria-hidden="true"></i></span> <?php echo formatBTC(convertToBTCFromSatoshi($vol_bit));?></div>
      </div>
      
      <div class="col-xs-12 col-xsl-4 col-sm-4 col-md-2 text-center">
        
      	<div class="branco montserrat-regular font-size-18 hint--top" aria-label="Volume em reais negociado nas últimas 24hs!"><span class="verde montserrat-extra"> R$</span> <?php echo number_format(($vol_fiat/100), 2, ',', '.');?></div>
      </div>
      
      <div class="col-xs-12 col-xsl-4 col-sm-4 col-md-5 text-left">
        <div class="branco montserrat-regular font-size-18 hint--top" aria-label="Variação do Bitcoin nas últimas 24hs!"><span class="verde montserrat-extra <?php if ( $variacao < 0 ) { echo 'vermelho';}?>"><i class="fa fa-clock-o" aria-hidden="true"></i> Δ </span> <?php echo $variacao;?>%</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-12">
            ...
            <a class="btn-padrao montserrat-semi text-center font-size-20 efeito" href="https://broker.brecoins.com.br/?p=signup" rel="nofollow">CADASTRE-SE</a>
      </div>
    </div>
  </div>   
</section>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-10 col-sm-offset-1 col-md-5 efeito" id="texto-bitcoin">
      		<h1 class="montserrat-extra"><span class="montserrat-extra vinho">O QUE É</span>BITCOIN</h1>
